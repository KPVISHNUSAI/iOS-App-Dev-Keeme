...
//    @Query private var UserCard: [Usr]
...
//    
//        
//        let SampleUserdata1 = Usr(firstName: "Rahul", lastName: "Sharma", isfav: false, username: "rahulsharma",keemes: [SampleKeemeSpace1])
//        let SampleUserdata2 =    Usr(firstName: "Priya", lastName: "Singh", isfav: true, username: "priyasingh",keemes: [SampleKeemeSpace2])
//        let SampleUserdata3 =  Usr(firstName: "Neha", lastName: "Patel", isfav: false, username: "nehapatel",keemes: [SampleKeemeSpace3])
//        let SampleUserdata4 = Usr(firstName: "Rohit", lastName: "Kumar", isfav: true, username: "rohitkumar",keemes: [SampleKeemeSpace4])
