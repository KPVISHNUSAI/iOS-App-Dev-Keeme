...
//    init(userID: UUID = UUID(), firstName: String, lastName: String, isfav: Bool, username: String, favouritebuddies: [Usr] = [Usr](), keemes: [KeemeSpace]? = nil) {
//        self.userID = userID
